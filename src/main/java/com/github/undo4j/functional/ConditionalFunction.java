...
final class ConditionalFunction<A, B> implements Function<A, B>, Copyable<ConditionalFunction<A, B>> {
	// instance variables
	...
	ConditionalFunction(Predicate p, Function<A, B> cThen, Function<A, B> cElse) {
	...
	/** */
	Function<A, B> getThen() {
		return functionThen;
	}

	/** */
	Function<A, B> getElse() {
		return functionElse;
	}
	...
	public boolean equals(Object o) {
		...
		return (predicate.equals(n.getPredicate()) && functionThen.equals(n.getThen()) && functionElse.equals(n
				.getElse()));
	}
