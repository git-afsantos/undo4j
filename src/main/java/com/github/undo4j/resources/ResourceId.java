...
public final class ResourceId implements Copyable<ResourceId> {
    ...
    **************************************************************************/
    ...
    private ResourceId(int id) { this.id = id; }


    /** Copy constructor of objects of class TransactionId. */
    private ResourceId(ResourceId instance) { this(instance.getId()); }
    ...
    **************************************************************************/
     ...
     */
    static ResourceId newResourceId() {
        return new ResourceId(NEXT_ID.incrementAndGet());
    }
    ...
    */
    ...
    @Override
    public ResourceId clone() { return new ResourceId(this); }
}
