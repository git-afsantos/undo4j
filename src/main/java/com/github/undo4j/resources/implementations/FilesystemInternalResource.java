...
public class FilesystemInternalResource implements InternalResource<FilesystemInterface> {
	...
	@Override
	public void applyState(ResourceState<FilesystemInterface> state) throws Exception {
