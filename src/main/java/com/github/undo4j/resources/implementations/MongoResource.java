...
public class MongoResource<T, D extends MongoDAO<T>> extends StatelessResource<MongoCollectionInterface<T, D>> {

	public MongoResource(InternalResource<MongoCollectionInterface<T, D>> resource, LockManager lockManager) {
	...
	public void rollback() {
		...
		try {
			ResourceState<MongoCollectionInterface<T, D>> resourceState = internalResource.buildState();
