...
import static com.github.undo4j.resources.StateUtil.cloneSafely;
import static com.github.undo4j.resources.StateUtil.identity;

import com.github.undo4j.common.LockManager;
import com.github.undo4j.common.LockManagers;

/**
 * ShadowResource is not thread-safe. Implements a resource with shadow writes.
 * 
 * @author afs
 * @version 2013
 */
...
public final class ShadowResource<T> extends SingleWriterStatefulResource<T> {
	...
	public ShadowResource(InternalResource<T> resource, LockManager lockManager) {
	...
	/**
	 * Stores the given state, as a shadow. The effective write happens on
	 * commit, applying the shadow state. This method assumes the resource has
	 * been acquired.
	 */
	@Override
	...
	/**
	 * Attempts to commit the changes made on this resource, invoking applyState
	 * on the internal resource. Also discards the stored shadow, after
	 * committing. Throws a ResourceCommitException, if any exception occurs,
	 * while applying the changes. This method assumes the resource has been
	 * acquired.
	 */
	@Override
	...
	/**
	 * Reverts the changes made on this resource. Throws a
	 * ResourceRollbackException, if any exception occurs while reverting the
	 * changes. This method does not distinguish between readers and writers.
	 * Such distinction (for instance, rollback behaving as an identity for
	 * readers) is beyond the scope of this class. This method assumes the
	...
	@Override
	public ShadowResource<T> clone() {
		return new ShadowResource<T>(this);
	}
}
