...
public abstract class MultiWriterStatefulResource<T> extends StatefulResource<T> {
	// instance variables
	private final ReentrantLock lock = new ReentrantLock();
	private final ThreadLocalStatus status = new ThreadLocalStatus();
	private final ThreadLocalResourceState<T> localCommit = new ThreadLocalResourceState<T>();
	 ...
	 */
	public MultiWriterStatefulResource(InternalResource<T> resource, LockManager lockManager) {
	 ...
	 * Parameter constructor of objects of class MultiWriterStatefulResource.
	 */
	public MultiWriterStatefulResource(InternalResource<T> resource, LockManager lockManager, boolean buildsEachUpdate) {
	...
	/** */
	static final class ThreadLocalResourceState<T> extends ThreadLocal<ResourceState<T>> {
		ThreadLocalResourceState() {
			super();
		}

		@Override
		protected ResourceState<T> initialValue() {
