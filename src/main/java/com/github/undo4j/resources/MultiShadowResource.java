...
public final class MultiShadowResource<T> extends MultiWriterStatefulResource<T> {
	private static final String INVALID_SHADOW = "invalid shadow state";

	// instance variables
	private final ThreadLocalResourceState<T> shadow = new ThreadLocalResourceState<T>();
	...
	public MultiShadowResource(InternalResource<T> resource, LockManager lockManager) {
		super(resource, lockManager);
	}

	/** Parameter constructor of objects of class MultiShadowResource. */
	public MultiShadowResource(InternalResource<T> resource, LockManager lockManager, boolean buildsEachUpdate) {
	 ...
	 * changes. This method assumes the resource has been acquired.
	 */
	@Override
