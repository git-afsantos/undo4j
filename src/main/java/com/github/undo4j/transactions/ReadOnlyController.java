...
final class ReadOnlyController extends ResourceController {
	...
	/**
	 * Throws a ReadOnlyHandleException. This handle does not support write
	 * executedOperations.
	 */
	@Override
	protected <T> void write(Resource<T> r, ResourceState<T> s) throws ReadOnlyControllerException {
	...
	@Override
	public ReadOnlyController clone() {
		return new ReadOnlyController(this);
	}
}
