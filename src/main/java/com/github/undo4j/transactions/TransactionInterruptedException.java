...
public final class TransactionInterruptedException
    ...
    **************************************************************************/
    ...
    /** Parameter constructor of objects of class TransactionInterruptedException. */
    TransactionInterruptedException(String message) { super(message); }
    ...
    /** Parameter constructor of objects of class TransactionInterruptedException. */
    TransactionInterruptedException(Throwable cause) { super(cause); }
}
