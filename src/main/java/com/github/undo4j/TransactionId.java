...
final class TransactionId implements Comparable<TransactionId> {
     ...
     */
    TransactionId(final int prefix, final int id) {
        this.id     = id;
        this.prefix = prefix;
    }
    ...
    /**
     * Compares this id to another transaction id.
     */
    @Override
    public int compareTo(final TransactionId tid) {
