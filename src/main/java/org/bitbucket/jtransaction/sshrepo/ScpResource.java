...
public final class ScpResource extends StatelessResource<String> {
	...
	/**
	 * Failed on renaming target directory: return.
	 * Failed on copying directory: Delete what was copied; restore old name.
	 * Failed on deleting old directory: retry deleting.
	 */
	@Override
