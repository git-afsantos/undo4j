...
public class StatefulResourceTest {
	...
	@Test
	public void setgetCheckpointTest(@NonStrict final ResourceState<String> mock)
			throws Exception {
	...
	@Test
	public void setgetPreviousCheckpointTest(
	...
	public void setgetCheckpointReferenceTestNotNull(
			@NonStrict final ResourceState<String> mock) {
		srt.setCheckpoint(mock);
	...
	public void setgetPrevCheckpointReferenceTestNull(
		...
		assertEquals(new NullState<String>(),
				srt.getPreviousCheckpointReference());
	}

	@Test
	public void updatePreviousCheckpointTest(
			@NonStrict final ResourceState<String> mock) throws Exception {
		srt.setCheckpoint(mock);
	...
	@Test
	public void revertCheckpointTest(@NonStrict final ResourceState<String> mock)
			throws Exception {
		srt.setPreviousCheckpoint(mock);
	...
	@Test
	public void rollbackToCheckpointTest(
			@NonStrict final ResourceState<String> mock) throws Exception {
		new Expectations() {
			{
				ir.applyState(mock);
